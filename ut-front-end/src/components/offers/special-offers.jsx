  ...
  const offers = [
    {
      ...
      description:
        "Get surprise addons with your first order and 10% off on your second order",
      code: "SURPRISE10",
      icon: Gift,
      bgColor: "#FFF4E6",
      iconBg: "#FCB53B",
    },
    {
      ...
      description: "Order 5 thalis and get 10% off",
      code: "BULK10",
      icon: Package,
      bgColor: "#E6F7E6",
      iconBg: "#84994F",
    },
    {
      id: 3,
      title: "Bulk Order Discount",
      description: "Order 20 thalis and get 20% off",
      code: "BULK20",
      icon: Users,
      bgColor: "#E6F3FF",
      iconBg: "#B45253",
        ...
        <div className="row">
          <div className="col-xl-12">
            <div className="tp-section-title-wrapper-3 mb-30 text-center">
              ...
              >
                Don&apos;t miss out on these amazing deals and save on your
                favorite thalis
              </p>
            </div>
          </div>
