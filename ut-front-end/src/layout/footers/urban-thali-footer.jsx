        ...
        <div className="row">
          ...
          >
            ...
            >
              ...
              >
                Bringing authentic Indian flavors to your doorstep with our
                carefully crafted thalis and traditional recipes.
              </p>
          ...
          <div
            className="col-xl-2 col-lg-2 col-md-6 col-sm-12 mb-4"
            style={{
            ...
            <div className="footer-contact">
              ...
              >
                ...
                >
                  ...
                  >
                    GROUND FLOOR, SHOP NO. 6, A Wing, JUHU TAJ, 6, NS Mankikar
                    Rd, nr. HSBC BANK, JVPD Scheme, Vile Parle West, Mumbai,
                    Maharashtra 400049
                  </p>
                </div>
        ...
        >
          <div className="row align-items-center">
            ...
            >
              ...
              >
                Made with <span style={{ color: "#ff69b4" }}>❤️</span> from{" "}
                <a href="https://nktech.in/"> NKTech</a>
              </p>
            </div>
          </div>
        </div>
